---
title: Weizenbaum's Secretary
date: 20 March 2024
author: David M. Berry and Sarah Ciston
---

Since 2021, part of the work of the Eliza Archaeology project has been trying to identify who might be the author of the conversation that Weizenbaum referred to in his 1966 paper and again in Computer Power and Human Reason (1976). He writes:
...
These questions are important because historically women have often been silenced or erased from the historical record. Here is an opportunity to right a historical wrong by giving authorship to the person(s) that inspired these discussions, a secretary that has been “famous” but seems to have no recorded name, face, or history, a "distressed young lady" who may never have known how famous she would become.

We know Weizenbaum’s name, we know all the men that worked on Project Mac (and often their photographs often posed against computer hardware), we can see their discussion, their words, their arguments, and again we can see that MIT in the 1960s was a very patriarchal place. So part of this project is to at least seek to do the work of showing how gendered computing was and how that was manifested during this period.

In our research team we have discussed whether this person(s) might be fictional or a composite of different users of the ELIZA system. The mystery of the secretary or the “young lady” is interesting because it’s still not clear if they even exist. Weizenbaum loved a “con” and then a reveal, as shown in his earlier writings, but with ELIZA he never revealed the women involved, only the mechanism that created the effect. We speculate that these may be composite women, in itself rather revealing, or it may be even a running joke in MIT at the time. Perhaps, in the same way that “Please go on…” became a running joke at MIT in the 1960s/70s.

<figure class="post-fig fig-left">
  <img src="images/3-weizenbaums-secretary-2.jpg" alt="Example of an alternative conversation (22 March 1965) MIT Archives (Computer Conversations 5 of 7).">
  <figcaption>Example of an alternative conversation (22 March 1965) MIT Archives (Computer Conversations 5 of 7).</figcaption>
</figure>
...
**McGuire, Lorch, and Quarton (1967: 180)**
...
![From Weizenbaum, J. (1967)](images/3-weizenbaums-secretary-5.jpg)
*From Weizenbaum, J. (1967)*
...
![Joseph Weizenbaum, personal archives, file 02-000311054.pdf](images/3-weizenbaums-secretary-6.jpg)
*Joseph Weizenbaum, personal archives, file 02-000311054.pdf*

However, more recently one of our informants who worked with Weizenbaum in the 1980s claimed to have been introduced by Weizenbaum's secretary to the ELIZA system when visiting MIT. The informant even claims that this was the original "young lady" and that Weizenbaum made a joke about her use of the system. However, unfortunately, as yet, we have been unable to pin down an actual name.

To try to resolve this issue we've tried to cross-check with other records in the MIT archives but we haven’t found anything substantive yet. These are, we think, the most likely people, if it was a secretary. The following are the people who were support staff in Project Mac whilst ELIZA was being programmed/released.

Blog Post by David M. Berry and Sarah Ciston

(Many thanks to Mark Marino who was instrumental in inspiring this blogpost and to the Team ELIZA, who were keen conversationalists during the writing of this post)

Update: After this was posted we became aware of Rebecca Roach's very interesting article discussing the same questions and we recommend you read it [https://theconversation.com/my-search-for-the-mysterious-missing-secretary-who-shaped-chatbot-history-225602](https://theconversation.com/my-search-for-the-mysterious-missing-secretary-who-shaped-chatbot-history-225602)

Update (1 Aug 2024): We now believe we know the name of Weizenbaum's secretary with a high degree of certainty. We are currently debating how we should approach naming and acknowledging her contribution.
...
The text of the exchange between the unnamed "young lady" and ELIZA is as follows, the computer's responses are printed entirely in capitals (Weizenbaum 1976: 4-3).
...
> Perhaps I could Jearn to get along with my mother.  
...
McGuire, M.T., Lorch, S. and Quarton, G.C. (1967) ‘Man-machine natural language exchanges based on selected features of unrestricted input—II. The use of the time-shared computer as a research tool in studying dyadic communication’, Journal of Psychiatric Research, 5(2), pp. 179–191.

McCorduck, Pamela (1972) ‘Joseph Weizenbaum -- Transcripts’ Carnegie Mellon University Archives, Box: 3, Folder: 8. Pamela McCorduck Collection, 1978-0001.

Project Mac (1966) Project Mac Progress IV 1966-67, p. 117-129.

Turkle, S. (1997) Life on the screen: identity in the age of the Internet. New York: Touchstone.

Weil, A. (1965) “Conversations with a Mechanical Psychiatrist.” The Harvard Review, Vol. 3, No. 2, pp. 68–73, 1965.
